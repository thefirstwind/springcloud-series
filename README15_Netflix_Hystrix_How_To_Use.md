...
##  Contents
*  1 [“Hello World!”](#anchor01)<!-- @IGNORE PREVIOUS: anchor -->
*  2 [Synchronous Execution](#anchor02)<!-- @IGNORE PREVIOUS: anchor -->
*  3 [Asynchronous Execution](#anchor03)<!-- @IGNORE PREVIOUS: anchor -->
*  4 [Reactive Execution](#anchor04)<!-- @IGNORE PREVIOUS: anchor -->
*  5 [Reactive Commands](#anchor05)<!-- @IGNORE PREVIOUS: anchor -->
*  6 [Fallback](#anchor06)<!-- @IGNORE PREVIOUS: anchor -->
*  7 [Error Propagation](#anchor07)<!-- @IGNORE PREVIOUS: anchor -->
*  8 [Command Name](#anchor08)<!-- @IGNORE PREVIOUS: anchor -->
*  9 [Command Group](#anchor09)<!-- @IGNORE PREVIOUS: anchor -->
* 10 [Command Thread-Pool](#anchor10)<!-- @IGNORE PREVIOUS: anchor -->
* 11 [Request Cache](#anchor11)<!-- @IGNORE PREVIOUS: anchor -->
* 12 [Request Collapsing](#anchor12)<!-- @IGNORE PREVIOUS: anchor -->
* 13 [Request Context Setup](#anchor13)<!-- @IGNORE PREVIOUS: anchor -->
* 14 [Common Patterns:](#anchor14)<!-- @IGNORE PREVIOUS: anchor -->
* 15 [Fail Fast](#anchor15)<!-- @IGNORE PREVIOUS: anchor -->
* 16 [Fail Silent](#anchor16)<!-- @IGNORE PREVIOUS: anchor -->
* 17 [Fallback: Static](#anchor17)<!-- @IGNORE PREVIOUS: anchor -->
* 18 [Fallback: Stubbed](#anchor18)<!-- @IGNORE PREVIOUS: anchor -->
* 19 [Fallback: Cache via Network](#anchor19)<!-- @IGNORE PREVIOUS: anchor -->
* 20 [Primary + Secondary with Fallback](#anchor20)<!-- @IGNORE PREVIOUS: anchor -->
* 21 [Client Doesn’t Perform Network Access](#anchor21)<!-- @IGNORE PREVIOUS: anchor -->
* 22 [Get-Set-Get with Request Cache Invalidation](#anchor22)<!-- @IGNORE PREVIOUS: anchor -->
* 23 [Migrating a Library to Hystrix](#anchor23)<!-- @IGNORE PREVIOUS: anchor -->


##  1 “Hello World!” <a name="anchor01"><a>
...
##  2 Synchronous Execution <a name="anchor02"><a>
...
##  3 Asynchronous Execution <a name="anchor03"><a>
...
##  4 Reactive Execution <a name="anchor04"><a>
...
```
More information about Observable can be found at [http://reactivex.io/documentation/observable.html](http://reactivex.io/documentation/observable.html)
##  5 Reactive Commands <a name="anchor05"><a>
...
##  7 Error Propagation <a name="anchor07"><a>
...
##  8 Command Name <a name="anchor08"><a>
...
```
##  9 Command Group <a name="anchor09"><a>
...
```
## 10 Command Thread-Pool <a name="anchor10"><a>
...
## 11 Request Cache <a name="anchor11"><a>
...
## 12 Request Collapsing <a name="anchor12"><a>
...
```
## 13 Request Context Setup <a name="anchor13"><a>
...
```
## 16 Fail Silent <a name="anchor16"><a>
...
```
## 17 Fallback: Static <a name="anchor17"><a>
...
```
## 18 Fallback: Stubbed <a name="anchor18"><a>
...
```
## 19 Fallback: Cache via Network <a name="anchor19"><a>
...
![](_images/fallback-via-command-640.png)
...
```
## 20 Primary + Secondary with Fallback <a name="anchor20"><a>
...
![](_images/primary-secondary-example-640.png)
...
## 21 Client Doesn’t Perform Network Access <a name="anchor21"><a>
...
```
## 22 Get-Set-Get with Request Cache Invalidation <a name="anchor22"><a>
...
```
## 23 Migrating a Library to Hystrix <a name="anchor23"><a>
...
![](_images/library-migration-to-hystrix-without-640.png)
...
![](_images/library-migration-to-hystrix-with-640.png)
